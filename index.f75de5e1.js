...
document.addEventListener("click", (evt)=>{
    ...
    spider.style.top = Math.max(0, Math.min(clickY - spiderHeigth / 2, maxY)) + "px";
    spider.style.left = Math.max(0, Math.min(clickX - spiderWidth / 2, maxX)) + "px";
});
